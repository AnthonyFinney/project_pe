...
export default function PromptForm({
  ...
  const addUseCase = () => {
    if (newUseCase.trim() && !promptData.useCases.includes(newUseCase.trim())) {
      setPromptData((prev) => ({
        ...prev,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle>Variables ({promptData.variables.length})</CardTitle>
                <Button
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setPromptData((prev) => ({ ...prev, category: value }))
                  }
                >
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value: "draft" | "published" | "archived") =>
                    setPromptData((prev) => ({ ...prev, status: value }))
                  }
                >
                  <SelectTrigger className="mt-1">
                    <SelectValue />
              ...
              <div className="flex items-center justify-between">
                <div>
                  <Label htmlFor="premium">Premium Prompt</Label>
                ...
                <Switch
                  id="premium"
                  checked={promptData.isPremium}
                  onCheckedChange={(checked) =>
                    setPromptData((prev) => ({ ...prev, isPremium: checked }))
                  }
                />
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">{promptData.tags.length}</span>
              </div>
              <div className="flex justify-between text-sm">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">{promptData.content.length}</span>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-sm whitespace-pre-wrap">
                    {promptData.content.replace(/\{([^}]+)\}/g, "{$1}")}
                  </p>
                </div>
              </CardContent>
            </Card>
