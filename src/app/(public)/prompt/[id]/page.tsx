                ...
                <div className="container mx-auto px-4 py-8 mt-16">
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 mb-6">
                            This prompt requires a premium subscription to
                            access.
                        </p>
                        <Link href="/pricing">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                {prompt.type === "image" && (
                                    <div className="mt-6 pt-6 border-t border-gray-200">
                                        ...
                                        <div className="text-xs text-gray-600 space-y-1">
                                            ...
                                            <p>
                                                • Specify quality and resolution
                                            </p>
                                            <p>
                                                • Add camera settings for
                                                realism
                                            </p>
                                        </div>
                                    </div>
                                ...
                                {showExample && (
                                    <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-md">
                                        ...
                                        <p className="text-xs text-green-600 mt-1">
                                            You can modify these values or use
                                            them as-is.
                                        </p>
                                    </div>
                                )}
                        ...
                        <div className="lg:col-span-2">
                            ...
                            >
                                ...
                                >
                                    <li>
                                        • Fill in all variables above to get the
                                        most effective prompt
                                    </li>
                                    <li>
                                        • You can edit the prompt directly if
                                        needed
                                    </li>
                                    <li>
                                        • Copy the final prompt to use with your
                                        favorite AI tool
                                    </li>
                                    <li>
                                        • Use the custom input option for
                                        select/dropdown fields when needed
                                    </li>
                                    {prompt.type === "image" && (
                                        <>
                                            <li>
                                                • Use with DALL-E, Midjourney,
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-3">
                                            <p className="text-sm text-gray-600">
                                                ...
                                                customized prompt might
                                                generate. The actual output will
                                                vary based on:
                                            </p>
                                            <ul className="text-sm text-gray-600 space-y-1">
                                                <li>
                                                    • Your specific variable
                                                    inputs
                                                </li>
                                                <li>
